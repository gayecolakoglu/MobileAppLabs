...
public class MainActivity extends AppCompatActivity implements com.example.mynotesfirebase.NoteFragment.OnNoteListInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!displayingEditor) {
            ...
            ft.add(R.id.container, com.example.mynotesfirebase.NoteFragment.newInstance(), "list_note");
            ft.commit();
        } else {
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ft.replace(R.id.container, com.example.mynotesfirebase.EditNoteFragment.newInstance(editingNote.getContent()));
        ...
        listenerRegistration = db.collection("notes").orderBy("date",
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                com.example.mynotesfirebase.NoteFragment listFragment = (com.example.mynotesfirebase.NoteFragment) getSupportFragmentManager().findFragmentByTag("list_note");
    ...
    public boolean onOptionsItemSelected(@Nullable MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_new:
                ...
                FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
                ft.replace(R.id.container, com.example.mynotesfirebase.EditNoteFragment.newInstance(""), "edit_note");
                ft.addToBackStack(null);
                ft.commit();
                return true;
    ...
    public void onBackPressed() {
        com.example.mynotesfirebase.EditNoteFragment editFragment = (com.example.mynotesfirebase.EditNoteFragment) getSupportFragmentManager().findFragmentByTag("edit_note");
        String content = null;
    ...
    public void onNoteSelected(Note note) {
        editingNote = note;
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.container, com.example.mynotesfirebase.EditNoteFragment.newInstance(editingNote.getContent()), "edit note");
        ft.addToBackStack(null);
        ft.commit();
        displayingEditor = !displayingEditor;
        invalidateOptionsMenu();
