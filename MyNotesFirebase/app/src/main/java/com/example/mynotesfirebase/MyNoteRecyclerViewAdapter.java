...
import com.example.mynotesfirebase.placeholder.PlaceHolderContent.PlaceholderItem;
...
public class MyNoteRecyclerViewAdapter extends
    ...
    private final com.example.mynotesfirebase.NoteFragment.OnNoteListInteractionListener mListener;

    public MyNoteRecyclerViewAdapter(List<Note> notes, com.example.mynotesfirebase.NoteFragment.OnNoteListInteractionListener listener) {
        mValues = notes;
        mListener = listener;
    }
